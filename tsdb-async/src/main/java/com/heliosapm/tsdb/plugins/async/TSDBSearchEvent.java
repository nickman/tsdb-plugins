 ...
 * <p>Description: Encapsulates a search event</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.tsdb.plugins.async.TSDBSearchEvent</code></p>
 */
...
public class TSDBSearchEvent extends TSDBEvent {
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.tsdb.plugins.async.TSDBEvent#deleteAnnotation(net.opentsdb.meta.Annotation)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.tsdb.plugins.async.TSDBEvent#indexAnnotation(net.opentsdb.meta.Annotation)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.tsdb.plugins.async.TSDBEvent#deleteTSMeta(java.lang.String)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.tsdb.plugins.async.TSDBEvent#indexTSMeta(net.opentsdb.meta.TSMeta)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.tsdb.plugins.async.TSDBEvent#deleteUIDMeta(net.opentsdb.meta.UIDMeta)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.tsdb.plugins.async.TSDBEvent#indexUIDMeta(net.opentsdb.meta.UIDMeta)
	 */
	@Override
