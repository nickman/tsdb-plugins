...
/**
 * <p>Title: DisruptorOracleLoadMetricsTest</p>
 * <p>Description: Search event handling unit tests using the Oracle DB and the Disruptor async driver.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>test.net.opentsdb.search.DisruptorOracleLoadMetricsTest</code></p>
 */

public class DisruptorOracleLoadMetricsTest extends LoadMetricsTest {
	...
	protected static void configureTSDB() {
		tsdb = newTSDB("OracleCatalogSearchDisruptorConfig");
	}
	...
	public static void initialize() {
		org.junit.Assume.assumeTrue(oracleAvailable("OracleCatalogSearchDisruptorConfig"));
