...
/**
 * <p>Title: DisruptorLoadMetricsTest</p>
 * <p>Description: Search event handling unit tests using the default in-mem H2 DB and the Disruptor async driver.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>test.net.opentsdb.search.DisruptorLoadMetricsTest</code></p>
 */

public class DisruptorLoadMetricsTest extends LoadMetricsTest {

	/**
	 * Configures the TSDB for all tests in this class.
	 */
	protected static void configureTSDB() {
		tsdb = newTSDB("CatalogSearchDisruptorConfig");
	}
