...
ALTER TABLE TSD_FQN_TAGPAIR ADD CONSTRAINT IF NOT EXISTS TSD_FQN_TAGPAIR_PK PRIMARY KEY ( FQNID, UID, PORDER ) ;
ALTER TABLE TSD_FQN_TAGPAIR ADD CONSTRAINT IF NOT EXISTS TSD_FQN_TAGPAIR_FK_UID FOREIGN KEY(UID) REFERENCES TSD_TAGPAIR ( UID );
...
ALTER TABLE TSD_FQN_TAGPAIR ADD CONSTRAINT IF NOT EXISTS TSD_FQN_TAGPAIR_FK_FQNID FOREIGN KEY(FQNID) REFERENCES TSD_FQN_TAGPAIR ( FQNID );
