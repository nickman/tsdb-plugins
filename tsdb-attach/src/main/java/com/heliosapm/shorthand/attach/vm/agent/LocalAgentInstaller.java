 ...
 * <p><code>com.heliosapm.shorthand.attach.vm.agent.LocalAgentInstaller</code></p>
 */
public class LocalAgentInstaller  {
	...
	public synchronized static Instrumentation getInstrumentation(long timeout) {
		...
		try {
			...
			try { ManagementFactory.getPlatformMBeanServer().removeNotificationListener(AgentInstrumentation.AGENT_INSTR_ON, listener); } catch (Exception e) {}
		}
