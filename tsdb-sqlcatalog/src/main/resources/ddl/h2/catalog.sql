...
CREATE TRIGGER IF NOT EXISTS TSD_FQN_UPDATED_TRG BEFORE INSERT,UPDATE,DELETE ON TSD_FQN FOR EACH ROW CALL "net.opentsdb.catalog.h2.triggers.TSMetaTrigger";
