...
CREATE OR REPLACE FUNCTION TSD_METRIC_UPDATED_TRG() RETURNS trigger AS $TSD_METRIC_UPDATED_TRG$
	...
	ELSEIF TG_OP='DELETE' THEN
		INSERT INTO SYNC_QUEUE (EVENT_TYPE, EVENT, OP_TYPE) VALUES (UPPER(TG_TABLE_NAME),OLD.XUID,'D');
...
CREATE OR REPLACE FUNCTION TSD_ANNOTATION_UPDATED_TRG() RETURNS trigger AS $TSD_ANNOTATION_UPDATED_TRG$
	...
	IF TG_OP='INSERT' THEN
		IF EQ != true THEN
			...
			END IF;
		END IF;
		INSERT INTO SYNC_QUEUE (EVENT_TYPE, EVENT, OP_TYPE) VALUES (UPPER(TG_TABLE_NAME),NEW.ANNID,'I');
	ELSEIF TG_OP='DELETE' THEN
		INSERT INTO SYNC_QUEUE (EVENT_TYPE, EVENT, OP_TYPE) VALUES (UPPER(TG_TABLE_NAME),OLD.ANNID,'D');
	ELSEIF TG_OP='UPDATE' THEN
		IF EQ != true THEN
			IF NEW.VERSION IS NULL THEN
				NEW.VERSION := 1;
			...
			END IF;
		END IF;
		INSERT INTO SYNC_QUEUE (EVENT_TYPE, EVENT, OP_TYPE) VALUES (UPPER(TG_TABLE_NAME),NEW.ANNID,'U');
	END IF;
	RETURN NEW;
    END;
...
CREATE OR REPLACE FUNCTION TSD_TSMETA_UPDATED_TRG() RETURNS trigger AS $TSD_TSMETA_UPDATED_TRG$
	...
	IF TG_OP='INSERT' THEN
		IF EQ != true THEN
			...
			END IF;
		END IF;
		INSERT INTO SYNC_QUEUE (EVENT_TYPE, EVENT, OP_TYPE) VALUES (UPPER(TG_TABLE_NAME),NEW.FQNID,'I');
	ELSEIF TG_OP='DELETE' THEN
		INSERT INTO SYNC_QUEUE (EVENT_TYPE, EVENT, OP_TYPE) VALUES (UPPER(TG_TABLE_NAME),OLD.FQNID,'D');
	ELSEIF TG_OP='UPDATE' THEN
		IF EQ != true THEN
			IF NEW.VERSION IS NULL THEN
				NEW.VERSION := 1;
			...
			END IF;
		END IF;
		INSERT INTO SYNC_QUEUE (EVENT_TYPE, EVENT, OP_TYPE) VALUES (UPPER(TG_TABLE_NAME),NEW.FQNID,'U');
	END IF;
	RETURN NEW;
    END;
