...
/**
 * <p>Title: PostgresLoadMetricsTest</p>
 * <p>Description: Search event handling unit tests using the Postgres DB and the EventBus async driver.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>test.net.opentsdb.search.OracleLoadMetricsTest</code></p>
 */

public class PostgresLoadMetricsTest extends LoadMetricsTest {
	...
	protected static void configureTSDB() {
		tsdb = newTSDB("PostgresCatalogSearchConfig");
	}
